...
const DescriptionCard = () => {
  ...
  const related = products.slice(0, 3); // Get first 3 related products
            ...
            <table className="min-w-full text-sm text-left text-gray-700 border border-gray-200">
              <tbody>
                <tr className="border-b border-gray-200">
                  <td className="p-2 font-medium bg-gray-50 whitespace-nowrap">
                    Model
                  </td>
        ...
        <div className="w-full lg:w-1/4 bg-white shadow rounded-xl py-10 px-10 h-fit">
          ...
          <div className="grid grid-cols-1 gap-3">
            {related.map((product, i) => (
              <div
                key={i}
                className="border border-gray-300 rounded p-1 text-center bg-white"
              >
                <img
                  src={product.image[0]}
                  alt={product.name}
