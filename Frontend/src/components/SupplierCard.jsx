...
const SupplierCard = () => {
  ...
  const similarProducts = products.slice(0, 3); // First 3 products
    ...
    <div className="p-4 bg-gray-50 sm:bg-white">
      ...
      <div className="px-2 py-2 bg-white rounded-xl sm:shadow sm:w-[350px]">
        <div className="flex items-center gap-3">
          <div className="bg-emerald-200 text-emerald-600 px-3 py-2 rounded font-bold text-sm">
            R
          </div>
          <div>
      ...
      <div className="mt-6 block lg:hidden bg-gray-50 rounded-xl p-2">
        ...
        <div className="grid grid-cols-3 gap-2">
          {similarProducts.map((product, index) => (
            <div
              key={index}
              className="border border-gray-300 rounded p-2 text-center bg-white"
            >
              <img
                src={product.image[0]}
                alt={product.name}
